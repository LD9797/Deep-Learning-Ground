...
#Concatenacion W, siempre tiene que ser 7 = 6 + 1
...
#(xTimesSteps, xInput, yTarget) = createInputAndGroundTruthData(sequenceLength)

#plt.figure()
#plt.scatter(xTimesSteps, yTarget.numpy())
#plt.show()
...
def createElmanModelParameters(contextConcatInputLayerSize, hiddenLayerSize, outputLayerSize):
    ...
    W1 = Variable(W1, requires_grad = True)  # Se inicializan las 2 matrices del modelo W y V
...
@param contextState, previous output in (t - 1) the sequence of hidden states, Esto es H(t - 1)
@param W1
@param V
"""
